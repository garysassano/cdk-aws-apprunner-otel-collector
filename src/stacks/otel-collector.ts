...
export class OtelCollectorStack extends Stack {
  constructor(scope: Construct, id: string, props: StackProps = {}) {
    ...
    const otelCollectorService = new Service(this, "OtelCollectorService", {
      ...
      source: Source.fromEcrPublic({
        imageIdentifier:
          "public.ecr.aws/asana/imgz/opentelemetry-collector-contrib:latest",
        imageConfiguration: {
          port: 4318,
          startCommand: `--config https://${confmapBucket.bucketName}.s3.${this.region}.amazonaws.com/collector-confmap.yml`,
    ...
    new NodejsFunction(this, "OtelHelloLambda", {
      ...
      environment: {
        ...
        // OTel Collector
        OTEL_EXPORTER_OTLP_ENDPOINT: `https://${otelCollectorService.serviceUrl}`,
